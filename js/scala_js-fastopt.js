...
$c_LElegoat_Letter.prototype = new $h_O();
$c_LElegoat_Letter.prototype.constructor = $c_LElegoat_Letter;
/** @constructor */
function $h_LElegoat_Letter() {
  /*<skip>*/
}
$h_LElegoat_Letter.prototype = $c_LElegoat_Letter.prototype;
$c_LElegoat_Letter.prototype.draw__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(ctx) {
  ctx["drawImage"](this.img$1, this.x$1, this.y$1, this.w$1, this.h$1)
});
$c_LElegoat_Letter.prototype.init___I__Lorg_scalajs_dom_raw_HTMLImageElement = (function(_y, img) {
  this.img$1 = img;
  this.x$1 = 0;
  this.y$1 = _y;
  this.w$1 = 50;
...
$c_LElegoat_Letter.prototype.move__V = (function() {
  this.x$1 = ((5 + this.x$1) | 0)
});
function $is_LElegoat_Letter(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LElegoat_Letter)))
}
function $as_LElegoat_Letter(obj) {
  return (($is_LElegoat_Letter(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "Elegoat.Letter"))
}
function $isArrayOf_LElegoat_Letter(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LElegoat_Letter)))
}
function $asArrayOf_LElegoat_Letter(obj, depth) {
  return (($isArrayOf_LElegoat_Letter(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LElegoat.Letter;", depth))
}
var $d_LElegoat_Letter = new $TypeData().initClass({
  LElegoat_Letter: 0
}, false, "Elegoat.Letter", {
  LElegoat_Letter: 1,
  O: 1
});
$c_LElegoat_Letter.prototype.$classData = $d_LElegoat_Letter;
/** @constructor */
function $c_LElegoat_MainApp$KeyCodes$() {
  $c_O.call(this);
  this.Up$1 = 0;
  this.Down$1 = 0
}
$c_LElegoat_MainApp$KeyCodes$.prototype = new $h_O();
$c_LElegoat_MainApp$KeyCodes$.prototype.constructor = $c_LElegoat_MainApp$KeyCodes$;
/** @constructor */
function $h_LElegoat_MainApp$KeyCodes$() {
  /*<skip>*/
}
$h_LElegoat_MainApp$KeyCodes$.prototype = $c_LElegoat_MainApp$KeyCodes$.prototype;
$c_LElegoat_MainApp$KeyCodes$.prototype.init___ = (function() {
  $n_LElegoat_MainApp$KeyCodes$ = this;
  this.Up$1 = 38;
  this.Down$1 = 40;
  return this
});
var $d_LElegoat_MainApp$KeyCodes$ = new $TypeData().initClass({
  LElegoat_MainApp$KeyCodes$: 0
}, false, "Elegoat.MainApp$KeyCodes$", {
  LElegoat_MainApp$KeyCodes$: 1,
  O: 1
});
$c_LElegoat_MainApp$KeyCodes$.prototype.$classData = $d_LElegoat_MainApp$KeyCodes$;
var $n_LElegoat_MainApp$KeyCodes$ = (void 0);
function $m_LElegoat_MainApp$KeyCodes$() {
  if ((!$n_LElegoat_MainApp$KeyCodes$)) {
    $n_LElegoat_MainApp$KeyCodes$ = new $c_LElegoat_MainApp$KeyCodes$().init___()
  };
  return $n_LElegoat_MainApp$KeyCodes$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
/** @constructor */
function $c_LElegoat_MainApp$() {
  $c_O.call(this);
  this.Elegoat$MainApp$$canvas$1 = null;
  this.Elegoat$MainApp$$keys$1 = null;
  this.score$1 = 0;
  this.letters$1 = null;
  this.imgWidth$1 = 0;
  this.imgHeight$1 = 0;
...
$c_LElegoat_MainApp$.prototype = new $h_O();
$c_LElegoat_MainApp$.prototype.constructor = $c_LElegoat_MainApp$;
/** @constructor */
function $h_LElegoat_MainApp$() {
  /*<skip>*/
}
$h_LElegoat_MainApp$.prototype = $c_LElegoat_MainApp$.prototype;
$c_LElegoat_MainApp$.prototype.init___ = (function() {
  $n_LElegoat_MainApp$ = this;
  this.Elegoat$MainApp$$canvas$1 = $g["document"]["getElementById"]("elegoat");
  this.Elegoat$MainApp$$keys$1 = new $c_scm_HashSet().init___();
  this.score$1 = 0;
  this.letters$1 = ($m_sci_List$(), $m_sci_Nil$());
  this.imgWidth$1 = 120;
  this.imgHeight$1 = 120;
  this.goatImg$1 = $g["document"]["getElementById"]("goat");
  this.y$1 = 0;
  this.prev$1 = $uD($g["Date"]["now"]());
  return this
});
$c_LElegoat_MainApp$.prototype.main__V = (function() {
  $g["document"]["onkeydown"] = (function(e$2) {
    var this$1 = $m_LElegoat_MainApp$().Elegoat$MainApp$$keys$1;
    var elem = $uI(e$2["keyCode"]);
    return $s_scm_FlatHashTable$class__addElem__scm_FlatHashTable__O__Z(this$1, elem)
  });
  $g["document"]["onkeyup"] = (function(e$2$1) {
    var this$2 = $m_LElegoat_MainApp$().Elegoat$MainApp$$keys$1;
    var elem$1 = $uI(e$2$1["keyCode"]);
    return $s_scm_FlatHashTable$class__removeElem__scm_FlatHashTable__O__Z(this$2, elem$1)
  });
  $g["setInterval"]((function() {
    $m_LElegoat_MainApp$().update__V()
  }), 15.0)
});
$c_LElegoat_MainApp$.prototype.draw__V = (function() {
  var ctx = this.Elegoat$MainApp$$canvas$1["getContext"]("2d");
  ctx["clearRect"](0.0, 0.0, $uI(this.Elegoat$MainApp$$canvas$1["width"]), $uI(this.Elegoat$MainApp$$canvas$1["height"]));
  var this$1 = this.letters$1;
  var these = this$1;
  while ((!these.isEmpty__Z())) {
    var arg1 = these.head__O();
    var x$2 = $as_LElegoat_Letter(arg1);
    x$2.move__V();
    var this$2 = these;
    these = this$2.tail__sci_List()
  };
  var this$3 = this.letters$1;
  var these$1 = this$3;
  while ((!these$1.isEmpty__Z())) {
    var arg1$1 = these$1.head__O();
    var x$3 = $as_LElegoat_Letter(arg1$1);
    x$3.draw__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(ctx);
    var this$4 = these$1;
    these$1 = this$4.tail__sci_List()
  };
  ctx["drawImage"](this.goatImg$1, (($uI(this.Elegoat$MainApp$$canvas$1["width"]) - this.imgWidth$1) | 0), this.y$1, this.imgWidth$1, this.imgHeight$1);
  ctx["font"] = "bold 20px Century Gothic";
  ctx["fillText"](new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["Score : ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.score$1])), (((-200) + $uI(this.Elegoat$MainApp$$canvas$1["width"])) | 0), (((-25) + $uI(this.Elegoat$MainApp$$canvas$1["height"])) | 0))
});
$c_LElegoat_MainApp$.prototype.sendNewLatter__V = (function() {
  var current = $uD($g["Date"]["now"]());
  var jsx$1 = this.prev$1;
  var this$1 = $m_s_util_Random$();
  if (((current - jsx$1) > (1500.0 + this$1.self$1.nextInt__I__I(500)))) {
    var this$2 = $m_s_util_Random$();
    var n = (((-50) + $uI(this.Elegoat$MainApp$$canvas$1["width"])) | 0);
    var y = this$2.self$1.nextInt__I__I(n);
    var jsx$3 = this.letters$1;
    var jsx$2 = new $c_LElegoat_Letter().init___I__Lorg_scalajs_dom_raw_HTMLImageElement(y, $g["document"]["getElementById"]("letter"));
    var this$3 = $m_sci_List$();
    this.letters$1 = $as_sci_List(jsx$3.$$plus$colon__O__scg_CanBuildFrom__O(jsx$2, this$3.ReusableCBFInstance$2));
    this.prev$1 = current
  }
});
$c_LElegoat_MainApp$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_LElegoat_MainApp$.prototype.update__V = (function() {
  this.sendNewLatter__V();
  var this$1 = this.Elegoat$MainApp$$keys$1;
  var elem = $m_LElegoat_MainApp$KeyCodes$().Up$1;
  if ($s_scm_FlatHashTable$class__containsElem__scm_FlatHashTable__O__Z(this$1, elem)) {
    this.y$1 = (((-5) + this.y$1) | 0)
  };
  var this$2 = this.Elegoat$MainApp$$keys$1;
  var elem$1 = $m_LElegoat_MainApp$KeyCodes$().Down$1;
  if ($s_scm_FlatHashTable$class__containsElem__scm_FlatHashTable__O__Z(this$2, elem$1)) {
    this.y$1 = ((5 + this.y$1) | 0)
  };
  if ((this.y$1 < 0)) {
    this.y$1 = 0
  };
  if ((this.y$1 > (($uI(this.Elegoat$MainApp$$canvas$1["height"]) - this.imgHeight$1) | 0))) {
    this.y$1 = (($uI(this.Elegoat$MainApp$$canvas$1["height"]) - this.imgHeight$1) | 0)
  };
  var this$3 = this.letters$1;
  $m_sci_List$();
  ...
  while ((!these.isEmpty__Z())) {
    var arg1 = these.head__O();
    var x = $as_LElegoat_Letter(arg1);
    if ((x.x$1 <= $uI($m_LElegoat_MainApp$().Elegoat$MainApp$$canvas$1["width"]))) {
      b.$$plus$eq__O__scm_ListBuffer(arg1)
    };
    var this$5 = these;
    these = this$5.tail__sci_List()
  };
  this.letters$1 = b.toList__sci_List();
  var this$6 = this.letters$1;
  $m_sci_List$();
  var l = new $c_scm_ListBuffer().init___();
  $m_sci_List$();
  var r = new $c_scm_ListBuffer().init___();
  var these$1 = this$6;
  while ((!these$1.isEmpty__Z())) {
    var arg1$1 = these$1.head__O();
    var letter = $as_LElegoat_Letter(arg1$1);
    if (((letter.x$1 > (($uI($m_LElegoat_MainApp$().Elegoat$MainApp$$canvas$1["width"]) - $m_LElegoat_MainApp$().imgWidth$1) | 0)) && (((letter.y$1 > $m_LElegoat_MainApp$().y$1) && (letter.y$1 < (($m_LElegoat_MainApp$().y$1 + $m_LElegoat_MainApp$().imgHeight$1) | 0))) || ((((letter.y$1 + letter.h$1) | 0) > $m_LElegoat_MainApp$().y$1) && (((letter.y$1 + letter.h$1) | 0) < (($m_LElegoat_MainApp$().y$1 + $m_LElegoat_MainApp$().imgHeight$1) | 0)))))) {
      var this$9 = l
    } else {
      var this$9 = r
    };
    this$9.$$plus$eq__O__scm_ListBuffer(arg1$1);
    var this$10 = these$1;
    these$1 = this$10.tail__sci_List()
  };
  var _1 = l.toList__sci_List();
  var _2 = r.toList__sci_List();
  this.score$1 = ((this.score$1 + $s_sc_LinearSeqOptimized$class__length__sc_LinearSeqOptimized__I(_1)) | 0);
  this.letters$1 = _2;
  this.draw__V()
});
$c_LElegoat_MainApp$.prototype["main"] = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_LElegoat_MainApp$ = new $TypeData().initClass({
  LElegoat_MainApp$: 0
}, false, "Elegoat.MainApp$", {
  LElegoat_MainApp$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_LElegoat_MainApp$.prototype.$classData = $d_LElegoat_MainApp$;
var $n_LElegoat_MainApp$ = (void 0);
function $m_LElegoat_MainApp$() {
  if ((!$n_LElegoat_MainApp$)) {
    $n_LElegoat_MainApp$ = new $c_LElegoat_MainApp$().init___()
  };
  return $n_LElegoat_MainApp$
}
$e["Elegoat"] = ($e["Elegoat"] || {});
$e["Elegoat"]["MainApp"] = $m_LElegoat_MainApp$;
...
//# sourceMappingURL=scala_js-fastopt.js.map
